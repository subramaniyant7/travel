                                            ...
                                            <div class="row mb-md-80">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="#" class="form-control form-control-custom" placeholder="First Name" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="fs-14 text-custom-black fw-500">Last Name</label>
                                                        <input type="text" name="#" class="form-control form-control-custom" placeholder="Last Name" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" name="#" class="form-control form-control-custom" placeholder="Phone No." required>
                                                    </div>
                                                </div>
                                                <div class="col-12">
